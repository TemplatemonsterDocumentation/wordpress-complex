	...
	<h3>Loading data from Google servers</h3>
     ...
     <p>Some countries have issues connecting to Google servers. This can cause issues with loading Google Fonts. To resolve these issues, please do the following: </p>

	<h5>If you come across an error "Can not load Google Fonts:"
please do the following </h5>
	<p>Open the function.php file in your theme and add the following:</p>
