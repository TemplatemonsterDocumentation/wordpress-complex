...
<h4>Element Style</h4>
 	...
 	<figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/adv/1.png">
  	</figure>
...
<h4>Classic Background Type</h4>
 	...
 	<figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/adv/2.png">
  	</figure>
...
<h4>Gradient Background Type</h4>
 	...
 	<figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/adv/3.png">
  	</figure>
...
<h4>Border </h4>
 	...
 	<figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/adv/4.png">
  	</figure>
...
<p><b>Box Shadow</b> — enable this option if you want to access the shadow advanced settings for this module, and need to apply shadow for it. </p>
 	...
 	<figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/adv/5.png">
  	</figure>
