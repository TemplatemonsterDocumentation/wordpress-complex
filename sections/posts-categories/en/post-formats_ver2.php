...
<h4 id="post_format_standard">Standard Post Format</h4>
...
<ul>
    <li><i class="fa fa-angle-right"></i>Ann: Hello Mike!</li>
    <li><i class="fa fa-angle-right"></i>Mike: Hello Ann!</li>
    <li><i class="fa fa-angle-right"></i>Ann: How are you Mike?</li>
...
<p>After the images are uploaded, you can find them in Media Library. Click <strong>Uploaded to this post</strong> to
   view the images.</p>
<?php if ($project == 'triptastic') { ?>

<figure class="img-polaroid"><img src="img/wordpress/uploaded-images_triptastic.png" alt=""></figure>
