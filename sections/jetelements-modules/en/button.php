...
<p><li><b>Button label text</b> - type in your custom text to use it as a button text.</li></p>
<p><li><b>Button link</b> - here you can paste your custom link to apply it to the button.</li></p></ul>

<h6>Settings</h6>

<ul class="marked-list">
<p><li><b>Hover effect</b> - here you can pick one of the hover effects to use it for the button (<b>none, fade, down slide, left slide, right slide, up scale, down scale</b>, etc.). </li></p>
<p><li><b>Use icon</b> - enable this option if you want to display icon for the button.</li></p>
<p><li><b>Icon position</b> - here you can specify the icon button position (<b>left, top, right, bottom</b>).</li></p></ul>
...
<ul class="marked-list">
<p><li><b>Custom size</b> - enable this option if you want to apply your custom height and width for the button.</li></p>
...
<p>Switch between <b>Normal</b> and <b>Hover</b> modes to apply different custom styles for the button icon. </p>

<ul class="marked-list">
<p><li><b>Color</b> - here you can apply your custom button icon color using color picker tool.</li></p>
<p><li><b>Font size</b> - use the controls or type in the icon font size value in px in the corresponding block.</li></p>
<p><li><b>Icon box width</b> - here you can specify the icon box width value using the controls. You can also type in the value in px in the corresponding block.</li></p>
<p><li><b>Icon box height</b> - here you can specify the icon box height value using the controls. You can also type in the value in px in the corresponding block.</li></p>
<p><li><b>Icon box color</b> - here you need to set the color to use it for the icon box. </li></p>
<p><li><b>Border type</b> - select the preferable border type to use it for the button.</li></p>
<p><li><b>Border radius</b> - here you can define the value of the border radius to make the angles more smooth and round.</li></p>
<p><li><b>Margin</b> - here you can define the margins for the button icon.</li></p></ul>

<h6>Label</h6>

<p>Switch between <b>Normal</b> and <b>Hover</b> modes to apply different custom styles for the button label text. </p>
