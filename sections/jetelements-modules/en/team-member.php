...
<p><li><b>Member Image</b> - select the image for the team member from the <b>media library</b> or upload one from the hard drive.</li></p>
<p><li><b>First Name</b> - input the team member’s first name.</li></p>
<p><li><b>Last name</b> - type in the team member’s last name. </li></p>
<p><li><b>Position</b> - add the team member’s work responsibilities.</li></p>
<p><li><b>Description</b> - here you can add the description of the work your team member does, the details about him.</li></p>
<p><li><b>Add Item</b> - click the button to add a new social network link to the team member. You’ll need to select the <b>social network icon</b>, type in its <b>label</b>, add a <b>link</b> leading to the member’s profile and <b>enable the label</b>. </li></p>
<p><li><b>Button Text</b> - input the text for the button.</li></p>
<p><li><b>Button URL</b> - here you can add the URL link to the team member’s page on this site. </li></p></ul>
...
<ul class="marked-list">
<p><li><b>Display in cover</b> - enable this option to display the team member’s name in the form of hint or when on hover.</li></p></ul>

<p>You can switch from customizing <b>First name</b> to changing style of the <b>Last name</b>. Just switch between the blocks to proceed to customization.</p>
...
<p><li><b>Text Alignment</b> - use this option to set the needed text alignment for the team member’s position text.</li></p></ul>
...
<p><li><b>Text Alignment</b> - use this option to set the needed text alignment for the team member’s description text.</li></p></ul>

<h6>Social </h6>

<ul class="marked-list">
<p><li><b>Display on cover</b> - enable this option to display the team member’s social icons in the form of hint or when on hover.</li></p>
<p><li><b>Alignment</b> - here you can define the preferable social icons alignment. It can be placed to the left, to the right, or remain centered.</li></p></ul>

<p>Switch from customizing social icons in the <b>Normal</b> mode to styling them up when on <b>Hover</b>. Just switch between these two modes when necessary.</p>

<ul class="marked-list">
<p><li><b>Icon Color</b> - here you can change the color of the social icons.</li></p>
<p><li><b>Icon Background Color</b> - here you can set the suitable background color for the social icons. </li></p>
<p><li><b>Icon Font Size</b> - here you can specify the social icons size using controls. </li></p>
<p><li><b>Icon Box Size</b> - here you can set the size of the social icons boxes (the colored circles behind the social icons). </li></p>
<p><li><b>Border Type</b> - here you can define the type of the border you need to use for the element.</li></p>
<p><li><b>Border Radius</b> - here you can set the border radius for the chosen border to make the border angles more round.</li></p>
...
<ul class="marked-list">
<p><li><b>Display in cover</b> - enable this option to display the team member’s action button in the form of hint or when on hover.</li></p>
<p><li><b>Alignment</b> - here you can define the preferable button alignment. It can be placed to the left, to the right, or remain centered.</li></p></ul>

<p>Here you can switch from customizing button in the <b>Normal</b> mode to styling it up in <b>Hover</b> mode. To do it just switch between this two modes.</p>
...
<ul class="marked-list">
<p><li><b>Background Type</b> - in this block you can choose, whether you want to use <b>classic</b> or <b>gradient</b> background type. The customization options vary for each type. The <b>Background Type</b> options are quite similar to the additional background type settings for <b>Advanced Carousel</b>.
