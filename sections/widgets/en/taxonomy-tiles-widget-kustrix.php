    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>
                This property sets the number of words limit for post description. Set 0 to hide the description
            </dd>
        </dl>
    </li>
    <li>
    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>
                Here you can define the layout type of the tiles
            </dd>
        </dl>
    </li>
    <li>
        <dl class="inline-term">
            ...
            <dd>
                Here you can define the number of columns to display the category or tag content (up to 4)
            </dd>
        </dl>
    </li>
     <li>
