    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>
                This property defines the excerpt limit by choosing a number of words from post's content
            </dd>
        </dl>
    </li>
    <li>
    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>
                Here you can define whether to Hide/Show the full screen button to display slider in full screen mode. It is not available in WordPress customizer preview
            </dd>
        </dl>
    </li>
    <li>
        <dl class="inline-term">
            ...
            <dd>
                This property specifies whether to shuffle slides randomly. The option is disabled by default
            </dd>
        </dl>
    </li>
    <li>
    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>
                Here you can define whether to Hide/Show the thumbnails arrows 
            </dd>
        </dl>
    </li>
    <li>
