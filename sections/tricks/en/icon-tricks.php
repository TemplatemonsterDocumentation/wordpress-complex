	...
	<p>Font icons can be added using Shortcode interface (Insert shortcode).Shortcodes that provide the font icon option include Icon picker element. Using this option you can preview and select required icon.</p>
