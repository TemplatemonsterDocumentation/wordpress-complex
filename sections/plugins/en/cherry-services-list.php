...
The plugin adds a custom post type named “Services”, which you can use to display what your company offers – in a professional way.
 	...
 	<figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/plugins/cherry-services-list.png">
  	</figure> 

<h4>Installing Cherry Services List</h4>

<p>So, let's take a closer look at how to install this plugin</p>
<ol class="index-list">
	<li><p> Upload the Cherry Services List plugin to your blog</p></li>
	<li><p> Activate it</p></li>
	<li><p> Enter your Cherry Services List API key</p></li>
</ol>
