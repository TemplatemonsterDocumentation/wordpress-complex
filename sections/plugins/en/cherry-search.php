...
<p> <a href="https://wordpress.org/plugins/cherry-search/" target="_blank"> Cherry Search</a> 
 allows you to send search queries without reloading the page via AJAX technology. In this way, users can find any information they are interested in quickly and easily. Thanks to a full range of settings, you can customize the functionality of the plugin the way you need.
</p>
...
<figure class="img-polaroid">
    <img src="img/plugins/cherry-search/main-settings.png">
</figure>
...
<figure class="img-polaroid">
    <img src="img/plugins/cherry-search/search-result-settings.png">
</figure>
<ul class="marked-list">
    <li>    
        <dl class="inline-term">
...
<figure class="img-polaroid">
    <img src="img/plugins/cherry-search/search-visual-settings.png">
</figure>
<ul class="marked-list">
    <li>    
        <dl class="inline-term">
...
<figure class="img-polaroid">
    <img src="img/plugins/cherry-search/notifications.png">
</figure>
<ul class="marked-list">
    <li>    
        <dl class="inline-term">
