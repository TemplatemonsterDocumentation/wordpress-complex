...
<ol class="index-list">
	<li><p>Navigate to <b>CrocoBlock > Theme</b> in WordPress Dasboard. </p></li>

			<figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/dashboard/theme.png">
  	</figure>

	<li><p>Here you can see if Kava theme is installed and active on your site. You can view the theme’s version, and see if it is needed to be updated. In the case there is an update you’ll be able to click <b>Update Now</b> option. </p></li>
