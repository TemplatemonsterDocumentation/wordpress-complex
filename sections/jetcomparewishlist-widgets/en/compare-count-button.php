...
<h4>Content</h4>
  ...
  <figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/comparecountbuttoncontent.png">
    </figure>

<ul class="marked-list">
<li><p><b>Button Icon</b> - here you can define an icon for the compare count button.</p></li>
<li><p><b>Button Label Text</b> - here you can insert a label text of the compare count button.</p></li></ul>

<h6>Icon</h6>
<ul class="marked-list">
<li><p><b>Use Icon</b> - enable this option if you want to display an icon on the compare count button.</p></li>
<li><p><b>Icon Position</b> - here you can specify position of the icon on the compare count button (left, top, right, bottom).</p></li></ul>
...
<h4>Style</h4>
  <figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/comparecountbuttonstyle.png">
    </figure>

<h5>General</h5>
<ul class="marked-list">
<li><p><b>Typography</b> - turn the option on to view the typography settings.</p></li>
<li><p><b>Custom Size</b> - enable this option if you want to set the custom size of the compare count button.</p></li>
...
<li><p><b>Color</b> - here you can pick color for the borders of the compare count button.</p></li>
<li><p><b>Border Radius</b> - here you can define the value of the border radius to make the angles more smooth and round.</p></li>
<li><p><b>Alignment</b> - here you can define the preferable alignment of the compare count button. It can be placed to the left, to the right, or remain centered.</p></li>
<li><p><b>Padding</b> - here you can set the preferable custom padding for the compare count button. Fill in the values for the top, bottom, right and left padding in pixels to apply your custom padding.</p></li>
<li><p><b>Margin</b> - here you can apply your custom margins in pixels or percentage to set them for the compare count button.</p></li></ul>
