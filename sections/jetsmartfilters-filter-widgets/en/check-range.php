...
<figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/widgets/w-7.png">
    </figure></li></p>

<ul class="marked-list">
<p><li><b>Select Filter</b> - here you need to select the filter that was previously created and has the Check Range filter type.</p>
...
<p><li><b>Show Apply button</b> - enable this option to display Apply button and allow the visitors set the range and only then apply the filter on button click.
...
<figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/widgets/w-8.png">
    </figure></li></p>

<h6>Items</h6>
<ul class="marked-list">
<p><li><b>Space between</b> - here you can set the space between the checkboxes and apply different spaces between them for mobile, tablet and desktop devices.</li></p></ul>

<h6>Checkbox</h6>
<ul class="marked-list">
<p><li><b>Size</b> - here you can specify the size to apply for the checkbox container.</li></p>
...
<p><li><b>Border radius</b> - here you can set the border radius to apply for the checkbox container to make its angles more smooth.</li></p></ul>
