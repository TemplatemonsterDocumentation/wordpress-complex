...
<h6>Use this filter widget to display the radio filter allowing to select from the options represented for the visitor’s choice.
...
<p><li><b>Select Filter</b> - here you need to select the filter that was previously created and has the Radio filter type.
...
Space between - here you can set the space between the radio options and apply different spaces between them for mobile, tablet and desktop devices.


Radio

Size - here you can specify the size to apply for the radio option container.
Switch between Hover and Normal modes to customize the appearance of both.
Background color - here you can apply the custom color to use inside the radio option container.
...
Size  - here you can set the size of the radio icon.
Color - here you can set the color to use for the radio icon.
