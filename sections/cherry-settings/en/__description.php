...
<figure class="img-polaroid">
    <img src="projects/<?php echo $project;?>/img/images/main-settings.png">
</figure>
...
<figure class="img-polaroid">
    <img src="projects/<?php echo $project;?>/img/images/search-result-settings.png">
</figure>
<ul class="marked-list">
    <li>    
        <dl class="inline-term">
...
<figure class="img-polaroid">
    <img src="projects/<?php echo $project;?>/img/images/search-visual-settings.png">
</figure>
<ul class="marked-list">
    <li>    
        <dl class="inline-term">
...
<figure class="img-polaroid">
    <img src="projects/<?php echo $project;?>/img/images/notifications.png">
</figure>
<ul class="marked-list">
    <li>    
        <dl class="inline-term">
