	...
	<p>When new version of Cherry Framework is available, you'll see notification message in your WordPress admin panel in "Dashboard -> Updates" section. </p>
	...
	<div class="alert alert-warning">
        <p>Reinstallation of Monstroid theme will delete your current theme and Cherry options changes. Please backup your data to save the changes.</p>
    </div>
	...
	<ol class="index-list">
		...
		<li>
			<p>Download theme archive and follow <a href="#manual-install">Manual Installation</a> to install the new version of Monstroid theme or</p>
		</li>
		<li>
			<p>you can use Monstroid Wizard ("Tools > Monstroid Wizard"). <b>Make sure the "Monstroid Wizard" plugin is deleted and reinstall it from <a href="http://cloud.cherryframework.com/downloads/wizard/monstroid-wizard.zip">this link</a> before update.</b></p>
		</li>		
		<li>
