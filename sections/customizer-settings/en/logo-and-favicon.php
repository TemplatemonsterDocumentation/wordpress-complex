...
<?php if ($project == 'monstroid_2' or $project == 'calio' or $project == 'guillermo' or $project == 'delicia' or $project == 'itideas' or $project == 'hotelbliss' or $project == 'propello') { ?>
...
<?php if ($project == 'monstroid_2' or $project == 'hotelbliss' or $project == 'propello') { ?>
