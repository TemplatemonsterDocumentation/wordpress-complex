...
<?php if ($project != 'trudeau' && $project != 'preservarium' && $project != 'talkingbusiness' && $project != 'quickwind' && $project != 'cupojava') { ?>
    <li>
        <dl class="inline-term">
...
<?php if ($project == 'fiona' or $project == 'plumberpro'  or $project == 'jericho' or $project == 'prima' or $project == 'cupojava') { ?>
    <li>
        <dl class="inline-term">
