...
<?php if ($project == 'monstroid_2' or $project == 'emanuella' or $project == 'glossylook' or $project == 'calio' or $project == 'guillermo' or $project == 'delicia' or $project == 'itideas' or $project == 'propello') { ?>
    <li>
        <dl class="inline-term">
            <dt>Layout</dt>
            <dd>
...
<?php if ( $project == 'monstroid_2' or $project == 'emanuella' or $project == 'glossylook' or $project == 'calio' or $project == 'guillermo' or $project == 'delicia' or $project == 'itideas' or $project == 'hotelbliss' or $project == 'propello') { ?>
    <li>
        <dl class="inline-term">
...
<?php if ($project == 'calio' or $project == 'guillermo' or $project == 'hotelbliss' or $project == 'propello') { ?>
    <li>
        <dl class="inline-term">
            <dt>Show top menu</dt>
            <dd>
...
<?php if ($project == 'emanuella' or $project == 'glossylook' or $project == 'calio' or $project == 'guillermo' or $project == 'delicia' or $project == 'itideas' or $project == 'hotelbliss' or $project == 'propello') { ?>
...
<?php if ($project == 'monstroid_2' or $project == 'bayden' or $project == 'emanuella' or $project == 'calio' or $project == 'presstige' or $project == 'guillermo' or $project == 'fabrique' or $project == 'hotelbliss' or $project == 'propello') { ?>
...
<?php if ($project == 'confucius' or $project == 'hidalgo' or $project == 'italica' or $project == 'gutenberg' or $project == 'monstroid_2' or $project == 'emanuella' or $project == 'glossylook' or $project == 'calio' or $project == 'delicia' or $project == 'itideas' or $project == 'hotelbliss' or $project == 'propello') { ?>
    <li>
        <dl class="inline-term">
...
<?php if ($project != 'confucius' && $project != 'hidalgo' && $project != 'italica' && $project != 'gutenberg' && $project != 'knox' && $project != 'monstroid_2' && $project != 'emanuella' && $project != 'glossylook' && $project != 'calio' && $project != 'delicia' && $project != 'itideas' && $project != 'hotelbliss' && $project != 'propello') { ?>
    <li>
        <dl class="inline-term">
