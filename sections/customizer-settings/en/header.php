...
<?php if ($project == 'vitahealth' or $project == 'newborn' or $project == 'metadental' or $project == 'petcenter' or $project == 'armyacademy' or $project == 'universalcare' or $project == 'roox' or $project == 'healthrehub' or $project == 'itsagirl') { ?>
...
<?php if ($project == 'monstroid_2' or $project == 'emanuella' or $project == 'glossylook' or $project == 'calio' or $project == 'guillermo' or $project == 'delicia' or $project == 'itideas' or $project == 'propello' or $project == 'bookit' or $project == 'thelegalway') { ?>
    <li>
        <dl class="inline-term">
            <dt>Layout</dt>
            <dd>
...
<?php if ($project != 'trudeau' && $project != 'preservarium' && $project != 'talkingbusiness' && $project != 'quickwind' && $project != 'cupojava' && $project != 'petinn' && $project != 'presidential' && $project != 'bloomie') { ?>
    <li>
        <dl class="inline-term">
...
<?php if ($project == 'walden' or $project == 'monstroid_2' or $project == 'stellarlook' or $project == 'hypernova' or $project == 'upbuild' or $project == 'shopable' or $project == 'dollarex') { ?>
    <li>
        <dl class="inline-term">
            <dt>Enable search</dt>
            <dd>
...
<?php if ( $project == 'monstroid_2' or $project == 'emanuella' or $project == 'glossylook' or $project == 'calio' or $project == 'guillermo' or $project == 'delicia' or $project == 'itideas' or $project == 'hotelbliss' or $project == 'propello' or $project == 'bookit' or $project == 'thelegalway') { ?>
    <li>
        <dl class="inline-term">
...
<?php if ($project == 'calio' or $project == 'guillermo' or $project == 'hotelbliss' or $project == 'propello' or $project == 'bookit' or $project == 'thelegalway') { ?>
    <li>
        <dl class="inline-term">
            <dt>Show top menu</dt>
            <dd>
...
<?php if ($project == 'takeandspend' or $project == 'speedyfix' or $project == 'legalalien' or $project == 'magnifio') { ?>
    <li>
        <dl class="inline-term">
            <dt>Phone Text </dt>
                <dd>
...
<?php if ( $project != 'advisto' && $project != 'fenimore' && $project != 'nolan' &&  $project != 'lawpress' && $project != 'ecolife' && $project != 'tradex' && $project != 'walden' && $project != 'stylefactory' && $project != 'petstore' && $project != 'greenfield' && $project != 'emanuella' && $project != 'glossylook' && $project != 'hypernova' && $project != 'delicia' && $project != 'shopable' && $project != 'itideas') { ?>
    <li>
        <dl class="inline-term">
            <dt>Disclaimer Text</dt>
                <dd>
...
<?php if ( $project != 'hidalgo' && $project != 'walden' && $project != 'emanuella' && $project != 'glossylook' && $project != 'hypernova' && $project != 'delicia' && $project != 'shopable' && $project != 'itideas' && $project != 'hotelbliss') { ?>
    <li>
        <dl class="inline-term">
            <dt>Background color</dt>
                <dd>
...
<?php if ( $project == 'room4pics' or $project == 'rufusvr' or $project == 'sabbatico' or $project == 'presidential') { ?>
    <li>
        <dl class="inline-term">
...
<?php if ($project == 'emanuella' or $project == 'glossylook' or $project == 'calio' or $project == 'guillermo' or $project == 'delicia' or $project == 'itideas' or $project == 'hotelbliss' or $project == 'propello' or $project == 'bookit' or $project == 'thelegalway') { ?>
...
<?php if ($project == 'monstroid_2' or $project == 'bayden' or $project == 'emanuella' or $project == 'calio' or $project == 'presstige' or $project == 'guillermo' or $project == 'fabrique' or $project == 'hotelbliss' or $project == 'propello' or $project == 'bookit' or $project == 'thelegalway') { ?>
...
<?php if ($project == 'glossylook' or $project == 'delicia' or $project == 'itideas') { ?>
...
<?php if ($project == 'confucius' or $project == 'hidalgo' or $project == 'italica' or $project == 'gutenberg' or $project == 'monstroid_2' or $project == 'emanuella' or $project == 'glossylook' or $project == 'calio' or $project == 'delicia' or $project == 'itideas' or $project == 'hotelbliss' or $project == 'propello' or $project == 'bookit' or $project == 'thelegalway') { ?>
    <li>
        <dl class="inline-term">
...
<?php if ($project != 'confucius' && $project != 'hidalgo' && $project != 'italica' && $project != 'gutenberg' && $project != 'knox' && $project != 'monstroid_2' && $project != 'emanuella' && $project != 'glossylook' && $project != 'calio' && $project != 'delicia' && $project != 'itideas' && $project != 'hotelbliss' && $project != 'propello' && $project != 'bookit' && $project != 'scapex') { ?>
    <li>
        <dl class="inline-term">
...
<?php if ($project == 'heavyhandlers' or $project == 'justizia') { ?>
    <li>
        <dl class="inline-term">
            <dt>Header call to action button</dt>
            <dd>
