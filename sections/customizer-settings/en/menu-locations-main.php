...
<?php if ($project == 'monstroid_2' or $project == 'glossylook' or $project == 'calio' or $project == 'guillermo' or $project == 'delicia' or $project == 'itideas' or $project == 'hotelbliss' or $project == 'propello' or $project == 'bookit' or $project == 'thelegalway') { ?>
        <li>
            <dl class="inline-term">
                <dt>Landing Main</dt>
                <dd>
                    Select landing main navigation menu
                </dd>
            </dl>
        </li>
<?php } ?>
