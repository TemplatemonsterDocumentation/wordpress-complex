...
<?php if ($project == 'stylefactory' or $project == 'petstore' or $project == 'niceinn') { ?>
    <li>
        <dl class="inline-term">
            <dt>Accent color (3)</dt>
            <dd>
...
<?php if ($project == 'grannali' or $project == 'agrilloc') { ?>
    <li>
        <dl class="inline-term">
            <dt>Accent color (3)</dt>
            <dd>
...
<?php if ($project == 'agrilloc') { ?>
    <li>
        <dl class="inline-term">
            <dt>Accent color (10)</dt>
            <dd>
                Third version of the main theme color
            </dd>
        </dl>
...
<?php if ($project == 'fashionia') { ?>
    <li>
        <dl class="inline-term">
            <dt>Entry meta color</dt>
            <dd>
            Select entry meta color  
            </dd>
        </dl>
    </li>
    <li>
        <dl class="inline-term">
            <dt>Blockquote color</dt>
            <dd>
            Select blockquote color  
            </dd>
        </dl>
    </li>  
<?php } ?>

<?php if ($project == 'petstore' or $project == 'trudeau' or $project == 'preservarium' or $project == 'talkingbusiness' or $project == 'exhibita' or $project == 'yoozie' or $project == 'pathter' or $project == 'navyblue' or $project == 'highridgecenter' or $project == 'smallsteps' or $project == 'mikebridge') { ?>
    <li>
        <dl class="inline-term">
            <dt>Button text color</dt>
            <dd>
...
<?php if ($project == 'takeandspend' or $project == 'speedyfix' or $project == 'legalalien' or $project == 'magnifio' or $project == 'shieldon') { ?>
    <li>
        <dl class="inline-term">
            <dt>Top Panel Text color</dt>
            <dd>
            Select Top panel text color
            </dd>
        </dl>
    </li> 
<?php } ?>
...
<?php if ($project == 'vitahealth' or $project == 'newborn' or $project == 'metadental' or $project == 'petcenter' or $project == 'armyacademy' or $project == 'universalcare' or $project == 'roox' or $project == 'healthrehub' or $project == 'itsagirl' or $project == 'globalhealth' or $project == 'dynasty' or $project == 'myfamilydoctor') { ?>
    <li>
        <dl class="inline-term">
            <dt>Regular input color</dt>
            <dd>
            Select regular input color
            </dd>
        </dl>
    </li> 
<?php } ?>
...
<?php if ($project == 'vitahealth' or $project == 'newborn' or $project == 'metadental' or $project == 'petcenter' or $project == 'armyacademy' or $project == 'universalcare' or $project == 'roox' or $project == 'healthrehub' or $project == 'itsagirl' or $project == 'globalhealth' or $project == 'dynasty' or $project == 'myfamilydoctor') { ?>
    <li>
        <dl class="inline-term">
            <dt>Footer text color</dt>
            <dd>
            Select text color in footer
            </dd>
        </dl>
    </li> 
<?php } ?>
...
<?php if ( $project == 'dailysports' or $project == 'fabrique') { ?>
    <li>
        <dl class="inline-term">
            <dt>Accent color (3)</dt>
            <dd>
...
<?php if ( $project == 'cosmetro' OR $project == 'kustrix' OR $project == 'cleaningpro' OR $project == 'focussity' or $project == 'shanti' or $project == 'pokemania'  or $project == 'malcolmy' or $project == 'interra') { ?>
    <li>
        <dl class="inline-term">
            <dt>Accent color (3)</dt>
            <dd>
...
<ul class="marked-list">
    <li>
        <dl class="inline-term">
            <dt>Gradient color (1)</dt>
            <dd>
                First version of gradient color
            </dd>
        </dl>
    </li>
    ...
    <li>
        <dl class="inline-term">
            <dt>Gradient color (2)</dt>
            <dd>
                Second version of gradient color
            </dd>
        </dl>
    </li>
