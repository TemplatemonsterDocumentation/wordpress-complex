...
<?php if ($project == 'petstore' or $project == 'trudeau' or $project == 'preservarium' or $project == 'talkingbusiness' or $project == 'exhibita') { ?>
    <li>
        <dl class="inline-term">
...
<?php if ($project == 'takeandspend' or $project == 'speedyfix') { ?>
    <li>
        <dl class="inline-term">
