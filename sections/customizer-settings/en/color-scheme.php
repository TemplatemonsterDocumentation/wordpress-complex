...
<?php if ($project == 'housepress') { ?>
    <li>
        <dl class="inline-term">
            <dt>Placeholder color</dt>
            <dd>
            Select the polaceholder color
            </dd>
        </dl>
    </li>
<?php } ?>
...
<?php if ( $project == 'cosmetro' OR $project == 'kustrix' OR $project == 'cleaningpro' OR $project == 'focussity' or $project == 'shanti' or $project == 'pokemania'  or $project == 'malcolmy' or $project == 'interra' or $project == 'maxwell') { ?>
    <li>
        <dl class="inline-term">
            <dt>Accent color (3)</dt>
            <dd>
