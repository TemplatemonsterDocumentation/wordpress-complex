...
<ul>
    <li>
        <dl class="inline-term">
            ...
            <dd>
                Set the background image for site identity
            </dd>
        </dl>
    </li>
    <li>
        <dl class="inline-term">
            ...
            <dd>
                Set background repeat for site identity image
            </dd>
        </dl>
    </li>
     <li>
        <dl class="inline-term">
            ...
            <dd>
                Set background position for site identity image
        </dl>
    </li>
     <li>
        <dl class="inline-term">
            ...
            <dd>
                Set background attachment for site identity image
            </dd>
        </dl>
    </li>
<?php } ?>
...
<h5>Preloader Upload</h5>

<p>Upload Preloader image</p>
<?php } ?>
...
<?php if ($project != 'ironmass' && $project !='bettaso' && $project !='mechanna' && $project !='advisto' && $project !='shanti' && $project != 'artwork' && $project != 'sensei' && $project !='lawpress' && $project != 'cookery' && $project != 'penn' && $project != 'masterchef' && $project != 'chopchop' && $project != 'whitewhale' && $project != 'tanaka' && $project != 'ecolife' && $project != 'happylearning' && $project != 'mizrahi' && $project != 'redhotgrill' && $project != 'inmotion' && $project != 'itashow toica' && $project != 'gutenberg' && $project != 'chefplaza' && $project != 'monstroid_2' && $project != 'armyacademy' && $project != 'universalcare' && $project != 'callista' && $project != 'quickwind' && $project != 'sportware' && $project != 'stellarlook' && $project != 'speedyfix' && $project != 'presstige' && $project != 'guillermo' && $project != 'sabbatico' && $project != 'exhibita' && $project != 'yoozie' && $project != 'legalalien' && $project != 'magnifio' && $project != 'pathter' && $project != 'fabrique' && $project != 'delicia' && $project != 'roox' && $project != 'upbuild' && $project != 'malcolmy' && $project != 'itideas' && $project != 'medkit' && $project != 'cupojava' && $project != 'hotelbliss' && $project != 'petinn' && $project != 'navyblue' && $project != 'justizia' && $project != 'presidential' && $project != 'propello' && $project != 'healthrehub' && $project != 'itsagirl' && $project != 'bookit' && $project != 'thelegalway' && $project != 'dollarex' && $project != 'bloomie' && $project != 'scapex' && $project != 'cellular' && $project != 'contractor' && $project != 'woostroid' && $project != 'loandolphins' && $project != 'therapino' && $project != 'spello' && $project != 'shieldon' && $project != 'espero' && $project != 'camphone' && $project != 'interra' && $project != 'highridgecenter' && $project != 'glossy_look' && $project != 'globalhealth' && $project != 'confevent' && $project != 'buyinto' && $project != 'carprotect' && $project != 'tripi' && $project != 'trickleup' && $project != 'smallsteps' && $project != 'rehealth' && $project != 'mikebridge' && $project != 'procount' && $project != 'fashionia' && $project != 'apollo' && $project != 'dynasty' && $project != 'marigold' && $project != 'myfamilydoctor' && $project != 'jonbin' && $project != 'bizacumen' && $project != 'fastway' && $project != 'lowrise' && $project != 'picalter' && $project != 'piperoni' && $project != 'rainbowscolors' && $project != 'ecopower' && $project != 'neobeat' && $project != 'griddling' && $project != 'adbreak' && $project != 'ivering' && $project != 'estadoz' && $project != 'slim' && $project != 'architera' && $project != 'counselor' && $project != 'maxwell' && $project != 'webbox' && $project != 'walton' && $project != 'downtheriver' && $project != 'housepress' && $project != 'maryville' && $project != 'dalton' && $project != 'lafood' && $project != 'dentalcenter' && $project != 'stexchange' && $project != 'cared4' && $project != 'identiz' && $project != 'latteccino' && $project != 'spatulas' && $project != 'inigo' && $project != 'akhmada')  { ?>
