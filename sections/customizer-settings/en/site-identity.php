...
<?php if ($project != 'ironmass' && $project !='bettaso' && $project !='mechanna' && $project !='advisto' && $project !='shanti' && $project != 'artwork' && $project != 'sensei' && $project !='lawpress' && $project != 'cookery' && $project != 'penn' && $project != 'masterchef' && $project != 'chopchop' && $project != 'whitewhale' && $project != 'tanaka' && $project != 'ecolife' && $project != 'happylearning' && $project != 'mizrahi' && $project != 'redhotgrill' && $project != 'inmotion' && $project != 'itashow toica' && $project != 'gutenberg' && $project != 'chefplaza' && $project != 'monstroid_2' && $project != 'armyacademy' && $project != 'universalcare' && $project != 'callista' && $project != 'quickwind' && $project != 'sportware' && $project != 'stellarlook' && $project != 'speedyfix' && $project != 'presstige' && $project != 'guillermo' && $project != 'sabbatico' && $project != 'exhibita')  { ?>
