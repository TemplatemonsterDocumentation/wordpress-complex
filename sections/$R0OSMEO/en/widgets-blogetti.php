...
<ul class="marked-list">
    ...
    <li>
        <dl class="inline-term">
            <dt>Before content widget areay</dt>
            <dd>
    ...
    <li>
        <dl class="inline-term">
            <dt>After content full widget area</dt>
            <dd>
...
<p>More info about widgets available <a href="/index.php?project=blogetti&lang=en&section=widgets#">here</a>.</p>