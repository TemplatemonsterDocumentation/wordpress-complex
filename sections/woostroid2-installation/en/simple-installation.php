...
<li><p>When the plugins are installed the green notices will appear informing you that the plugins are already installed and active on your site. The blue progress bar will show how long it will take to install all the selected plugins.</p></li></ol>
      ...
      <figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/installation/wizard-new8.png">
    </figure>

<ol class="index-list">
<li><p>It’s time to install demo content. After the plugins are installed you can see the <b>We’re almost there</b> page where one can choose if you want to:</p>


      <figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/installation/wizard-new9.png">
    </figure>
...
<li>switch the skin.</li></ul></p></li></ol>
