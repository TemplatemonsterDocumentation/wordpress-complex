<h3>Step 5. Dummy Data Installation</h3>

<ol class="index-list">
<li><p>Now it is time to import the dummy data <b>XML</b> in order to add the demo content, which includes products.</p>

<p>To do it, please, navigate to <b>Tools > Import</b> tab in the left column of the Dashboard.</p>
	<figure class="img-polaroid"><img src="img/wookit/18.png" alt=""></figure>
<p>Scroll the page down and locate <b>WordPress importer</b> tool. Click <b>Run Importer</b> option.</p></li>
	<figure class="img-polaroid"><img src="img/wookit/19.png" alt=""></figure>
