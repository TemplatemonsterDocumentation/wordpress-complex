<h3>Manual Installation</h3>
    ...
    <p>2. Navigate to the <strong>Appearance > Themes</strong> section at the admin panel of the site and open  the  <strong>Theme</strong> folder.</p>
    <p>3. Locate the archive named as <strong>theme-name.zip</strong> and install the theme by pressing <strong>Install Now</strong>.</p>
