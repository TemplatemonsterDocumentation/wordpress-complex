...
<ul class="marked-list">
    <li>
        ...
        <ul class="marked-list">
            ...
            <p>
                1.2 Save the "wp-content/themes/woostroid" folder (duplicate it), just so it stays somewhere on your web server, let’s say in a folder named “main monstroid backup”
    ...
    <li>
        ...
        <figure class="img-polaroid">
                <img src="img/man-update-3.png" alt=""/>
        </figure>
        </ul>
    </li>
    <li>
