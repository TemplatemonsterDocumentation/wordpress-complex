...
<h5>In this block you can access advanced appearance settings of the widgets, define widget margins and padding, entrance animation, change the background for the whole widget, etc.
</h5>

    <figure class="img-polaroid">
        <img src="projects/<?php echo $project;?>/img/modules/advanced.png">
    </figure>
...
<p>Here you can switch from customizing <b>Normal</b> to <b>Hover</b> background style settings. Just click on the button <b>Hover</b> to proceed to customizing hover elements. </p>
...
<p>Here you can switch from customizing <b>Normal</b> to <b>Hover</b> border style settings. Just click on the button Hover to proceed to customizing hover elements. </p>
