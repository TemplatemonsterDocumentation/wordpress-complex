...
<p>Copy this code. Then open the edit menu (<strong>'Pages -> Edit'</strong>) of the page where you wish to place the contact form. A popular practice is creating a page named 'Contact' for the contact form page. Paste the code you've copied into the contents of the page.</p>
