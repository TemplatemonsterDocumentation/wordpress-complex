...
<figure class="img-polaroid">
	<img src="img/cherryframework/third-party-plugins/mailchimp-1.png" alt="">
</figure>

<h4>Checkbox Settings</h4>
<h5>MailChimp settings for checkboxes</h5>
<ul class="marked-list">
		<li>
			<dl class="inline-term">
				<dt>MailChimp Lists</dt>
				<dd>
					Choose the list.
				</dd>
			</dl>
...
<h5>Checkbox settings</h5>
<ul class="marked-list">
		<li>
			<dl class="inline-term">
				<dt>Add the checkbox to these forms</dt>
				<dd>
	...
	<figure class="img-polaroid">
		<img src="img/cherryframework/third-party-plugins/mailchimp-2.png" alt="">
	</figure>


<h4>Form Settings</h4>
<h5>Required form settings</h5>
<ul class="marked-list">
		<li>
			<dl class="inline-term">
				<dt>Load form styles (CSS)?</dt>
				<dd>
...
<h5>Form Settings &amp; Messages</h5>
<ul class="marked-list">
		<li>
			<dl class="inline-term">
				<dt>Enable AJAX form submission?</dt>
				<dd>
	...
	<figure class="img-polaroid">
		<img src="img/cherryframework/third-party-plugins/mailchimp-3.png" alt="">
	</figure>