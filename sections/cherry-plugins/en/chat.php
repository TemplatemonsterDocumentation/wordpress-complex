...
<p>Talking with chat operator you can also use chat tools: </p>

<ul class="marked-list">
    <li><strong>Help Center</strong> - open online help center where you can view various text and video tutorials;</li>
    <li><strong>Submit a ticket</strong> - if your issue can not be resolved in live chat, you can use online help desk
                                         and submit a ticket;
    </li>
...
<figure class="img-polaroid">
    <img src="img/cherryframework/plugins/chat_disconnect.jpg" alt="">
</figure>
