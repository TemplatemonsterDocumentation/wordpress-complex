...
<p><a href="https://github.com/CherryFramework/cherry-mailer">Cherry Mailer</a> - the plugin to manage mailing list subscriptions and allows to implement newsletter subscription for visitors.</p>
	...
	<ul class="marked-list">
		<li>
			<dl class="inline-term">
				...
				<dd>
					Set your Api Key - API stands for application programming interface. It can be helpful to think of the API as a way for different apps to talk to one another base.
				</dd>
			</dl>
		</li>
		<li>
		...
		<li>
			<dl class="inline-term">
				<dd>
					Button which Generate Mailer shortcode
				</dd>
			</dl>
		</li>
	</ul>
...
<p>Paste this shortcode to page content section, which you want to use as subscription.</p>
