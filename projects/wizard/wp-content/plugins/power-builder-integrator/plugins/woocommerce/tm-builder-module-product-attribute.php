...
class Tm_Builder_Product_Attribute extends Tm_Builder_Module {
	...
	function init() {
		$this->name = esc_html__( 'Product Attribute', 'tm-builder-integrator' );
		$this->icon = 'f07a';
	...
	function get_fields() {
		...
		$fields = array(
			...
			'attribute' => array(
				'label'       => esc_html__( 'Attribute', 'tm-builder-integrator' ),
				'type'        => 'text',
				'description' => '',
			),
			'filter' => array(
				'label'       => esc_html__( 'Filter', 'tm-builder-integrator' ),
				'type'        => 'text',
				'description' => '',
			),
			'admin_label' => array(
