 ...
 */
do_action('mprm_before_widget_menu_item_grid');
/**
 ...
 * @hooked mprm_menu_item_grid_excerpt - 50
 * @hooked mprm_menu_item_grid_price - 60
 * @hooked mprm_menu_item_grid_footer - 70
 */
do_action('mprm_widget_menu_item_grid');
/**
 ...
 */
do_action('mprm_after_widget_menu_item_grid');