...
namespace MPHB\Library\WP_SessionManager;
...
add_action( 'plugins_loaded', '\MPHB\Library\WP_SessionManager\wp_session_start' );
...
add_action( 'shutdown', '\MPHB\Library\WP_SessionManager\wp_session_write_close' );
...
add_action( 'mphb_wp_session_garbage_collection', '\MPHB\Library\WP_SessionManager\wp_session_cleanup' );
...
add_action( 'wp', '\MPHB\Library\WP_SessionManager\wp_session_register_garbage_collection' );
