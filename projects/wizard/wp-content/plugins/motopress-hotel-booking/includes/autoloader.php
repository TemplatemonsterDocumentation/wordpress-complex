...
class Autoloader {
	...
	private function setupCustomPathList(){
		$this->customPathList['Library\\WP_SessionManager\\Recursive_ArrayAccess']	 = 'library/wp-session-manager/class-recursive-arrayaccess.php';
		$this->customPathList['Library\\WP_SessionManager\\WP_Session']				 = 'library/wp-session-manager/class-wp-session.php';
		$this->customPathList['Library\\EDD_Plugin_Updater\\EDD_Plugin_Updater']	 = 'library/edd-plugin-updater/edd-plugin-updater.php';
	}
