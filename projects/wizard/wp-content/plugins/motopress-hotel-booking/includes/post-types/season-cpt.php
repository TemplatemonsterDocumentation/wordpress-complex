...
class SeasonCPT extends AbstractCPT {
	...
	public function getFieldGroups(){
		$generalGroup	 = new Groups\MetaBoxGroup( 'General', __( 'Season Info', 'motopress-hotel-booking' ), $this->postType );
		$generalFields	 = array();
		...
		$generalFields[] = Fields\FieldFactory::create( 'mphb_days', array(
				...
				'description' => __( 'Required. Hold Ctrl / Cmd to select multiple.', 'motopress-hotel-booking' ),
				)
		);
