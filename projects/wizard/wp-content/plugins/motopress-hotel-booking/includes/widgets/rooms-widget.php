...
class RoomsWidget extends BaseWidget {
	...
	function __construct(){
		...
		$widgetOptions = array(
			'description' => __( 'Display Room Types', 'motopress-hotel-booking' )
		);
	...
	public function form( $instance ){
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'room_type_ids' ) ); ?>"><?php _e( esc_attr( 'Select Room Types:' ) ); ?></label><br/>
