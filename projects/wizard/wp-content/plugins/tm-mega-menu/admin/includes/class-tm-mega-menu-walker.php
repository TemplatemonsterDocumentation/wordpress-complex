...
if( ! class_exists( 'Tm_Mega_Menu_Walker_Edit' ) ) :
 ...
 * @uses Walker
 */
class Tm_Mega_Menu_Walker_Edit extends Walker_Nav_Menu_Edit {
			...
			<div class="menu-item-bar">
				<div class="menu-item-handle">
					<span class="item-title">
						...
						<span class="tm-mega-menu-launch" data-id="<?php echo $item_id; ?>" data-title="<?php echo esc_html( $title ); ?>" data-depth="<?php echo $depth; ?>"><?php _e( 'Mega Menu', 'tm-mega-menu' ); ?></span>
					</span>
