...
add_action( 'booked_admin_confirmation_email', 'booked_mailer', 10, 3 );
add_action( 'booked_reminder_email', 'booked_mailer', 10, 3 );
add_action( 'booked_admin_reminder_email', 'booked_mailer', 10, 3 );
add_action( 'booked_cancellation_email', 'booked_mailer', 10, 3 );
add_action( 'booked_admin_cancellation_email', 'booked_mailer', 10, 3 );
				...
				while ($bookedAppointments->have_posts()):
					...
					if (!$reminder_sent):
						...
						if ($email_content && $email_subject):
							...
							do_action( 'booked_admin_reminder_email', $admin_email, $email_subject, $email_content );
						endif;
