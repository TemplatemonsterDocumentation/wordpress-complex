...
<div class="bbp-topic-header">
	...
	<div class="bbp-topic-title">
		...
		<h3><?php esc_html_e( 'Topic: ', 'monstroid2' ); ?>
		...
		<div class="bbp-topic-title-meta">
			...
			<?php if ( function_exists( 'bbp_is_forum_group_forum' ) && bbp_is_forum_group_forum( bbp_get_topic_forum_id() ) ) : ?>
				...
				<?php esc_html_e( 'in group forum ', 'monstroid2' ); ?>

			<?php else : ?>

				<?php esc_html_e( 'in forum ', 'monstroid2' ); ?>
...
<div id="post-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
	...
	<div class="bbp-topic-author">
		...
		<?php bbp_topic_author_link( array( 'sep' => '<br />', 'show_role' => false, 'size' => 71 ) ); ?>
